...
INSERT INTO public.properties VALUES (4, 'metal', 9.012, 1287, 2470, 3);
...
--
-- Name: elements name_symbol_uniqe; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT name_symbol_uniqe UNIQUE (symbol, name);
